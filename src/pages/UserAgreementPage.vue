<template>
  <q-page padding class="doc-page">
    <div class="q-mb-md">
      <q-btn flat dense color="primary" icon="arrow_back" :label="$t('close')" @click="handleClose" />
    </div>
...
import userAgreementMd from 'src/assets/user-agreement.generated.md?raw';
...
const html = computed(() => md.render(userAgreementMd));
